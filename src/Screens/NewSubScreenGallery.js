...
const WORLDS_DATA = {
    ...
    'ambiental': {
        ...
        png: [1, 2, 3, 4, 5, 6],
        actiTit: 'GUARDIÁN DE LA NATURALEZA',
        actiSub: 'Convertite en un mágico guardián o guardiana',
        color: '#00b2e3',
        video: 'guardian_acti.mp4',
        colorFg: '#fedadf',
        question: '¿QUÉ ES UN GUARDIÁN?',
        answer: 'Es un protector mágico de la naturaleza.',
        content: 'Comenzarás a ilustrar las primeras páginas de tu LIBRO.' +
            '\nBusca las hojas de papel recicladas y los acetatos (hojas transparentes) que vienen en tu KIT DE CREATIVIDAD.' +
            '\nUsa un lápiz para dibujar en la hoja de papel el Guardián en el que te quieres convertir y añade los elementos y objetos que consideres necesarios.' +
            '\nTambién podés usar el acetato para dibujar o pegar otros elementos que ayuden a darle un toque diferente a tu mágica creación',
        art: [{"name":	"AGUA"	,"hover":	"AGUA"	,"img":	"AGUA.jpg"	,"thumb":	"AGUA_MINI.png"	,"content":	"AGUA_i.png"	},
            {"name":	"AIRE"	,"hover":	"AIRE"	,"img":	"AIRE.jpg"	,"thumb":	"AIRE_MINI.png"	,"content":	"AIRE_i.png"	},
            {"name":	"ARBOLES SAGRADOS"	,"hover":	"ARBOLES SAGRADOS"	,"img":	"ARBOLES_SAGRADOS.jpg"	,"thumb":	"ARBOLES_SAGRADOS_MINI.png"	,"content":	"ARBOLES_SAGRADOS_i.png"	},
            {"name":	"BÚHO"	,"hover":	"BÚHO"	,"img":	"BUHO.jpeg"	,"thumb":	"BUHO_MINI.png"	,"content":	"BUHO_i.png"	},
            {"name":	"FLORES"	,"hover":	"FLORES"	,"img":	"FLORES.jpg"	,"thumb":	"FLORES_MINI.png"	,"content":	"FLORES_i.png"	},
            {"name":	"FUEGO"	,"hover":	"FUEGO"	,"img":	"FUEGO.jpg"	,"thumb":	"FUEGO_MINI.png"	,"content":	"FUEGO_i.png"	},
            {"name":	"JAGUAR"	,"hover":	"JAGUAR"	,"img":	"JAGUAR.jpg"	,"thumb":	"JAGUAR_MINI.png"	,"content":	"JAGUAR_i.png"	},
            {"name":	"LUNA"	,"hover":	"LUNA"	,"img":	"LUNA.jpg"	,"thumb":	"LUNA_MINI.png"	,"content":	"LUNA_i.png"	},
            {"name":	"MADRE TIERRA"	,"hover":	"MADRE TIERRA"	,"img":	"MADRE_TIERRA.jpeg"	,"thumb":	"MADRE_TIERRA_MINI.png"	,"content":	"MADRE_TIERRA_i.png"	},
            {"name":	"PLUMAS"	,"hover":	"PLUMAS"	,"img":	"PLUMAS.jpg"	,"thumb":	"PLUMAS_MINI.png"	,"content":	"PLUMAS_i.png"	},
            {"name":	"QUETZAL"	,"hover":	"QUETZAL"	,"img":	"QUETZAL.jpg"	,"thumb":	"QUETZAL_MINI.png"	,"content":	"QUETZAL_i.png"	},
            {"name":	"RAYO"	,"hover":	"RAYO"	,"img":	"RAYO.jpg"	,"thumb":	"RAYO_MINI.png"	,"content":	"RAYO_i.png"	},
            {"name":	"SOL"	,"hover":	"SOL"	,"img":	"SOL.jpg"	,"thumb":	"SOL_MINI.png"	,"content":	"SOL_i.png"	},
        ]
    },
    'colaboracion': {
        bg: 'colaboracion-bg',
...
export default class NewSubScreenGallery extends Component {
    constructor(props) {
        super(props);
        this.state = {
            showModal: false,
                ...
                return (
                    <div className={'row nomargin world-modal-con nopadding generosidad-bg'}>
                        ...
                        <div className={'col-md-6 world-modal-img-con'}>
                            <img alt={'info-img'} src={'/static/img/newexploregallery/' + this.props.world + '/' + this.state.modalInfo.img} />
                        </div>
                        <div className={'col-md-6 world-modal-info-con generosidad-info d-block'}>
                            <img className={this.state.mobile && !this.state.vertical ? 'data-img-alt' : 'data-img'} alt={'info'}
                                 src={'/static/img/newexploregallery/' + this.props.world + '/' + this.state.modalInfo.content} />
                        </div>
                    </div>
                );
            case 'autoestima':
    ...
    render() {
        ...
        const translate_world = {
            ambiental: 'guardianes'
        }
        return (
            <div>
                <MobileNavBar/>
                ...
                <div className={'row nomargin ssg-car ssg-bg mtnav ' + (this.state.mobile && this.state.vertical ? config.bgVert : config.bg)}>
                    {
                        this.state.mobile && !this.state.vertical ?
                            <div className={'col-12'}>
                                <img className={'ssg-title-alt'} src={'/static/img/newexploregallery/' +
                                this.props.world + '/title.png' } alt={config.sub} />
                            </div> :
                            <div className={'col-12'}>
                                <img className={'ssg-title'} src={'/static/img/newexploregallery/' +
                                this.props.world + '/title.png' } alt={config.sub} />
                            </div>
                    }
                    {
                        config.png.map((p) =>
                            <img alt={'png'} src={'/static/img/newexploregallery/' +
                                        ...
                                        k%3 === 1 ?
                                            <div key={'mob' + k}>
                                                <div className={'ssg-car-item ssg-car-item2'}
                                                    ...
                                                    <img
                                                        alt={'png'} src={'/static/img/newexploregallery/' +
                ...
                {
                    translate_world[this.props.world] === 'guardianes' || translate_world[this.props.world] === 'generosidad'
                   /* || translate_world[this.props.world] === 'colaboracion'*/ || translate_world[this.props.world] === 'ambiental'
                        ?
                            this.state.mobile && this.state.vertical ?
                                <div className={'row nomargin entrance-bg-alt'}>
                                    <div className={'col-12'}>
                                        <Link to={'/' + translate_world[this.props.world] + '/galeria/exploradores/asucentral'}>
                                            <h2>{'Asuncion / Central'}</h2>
                                        </Link>
                                    </div>
                                    <div className={'col-12'}>
                                        <Link to={'/' + translate_world[this.props.world] + '/galeria/exploradores/remansito'}>
                                            <h2>{'Remansito'}</h2>
                                        </Link>
                                    </div>
                                    <div className={'col-12'}>
                                        <Link to={'/' + translate_world[this.props.world] + '/galeria/exploradores/villeta'}>
                                            <h2>{'Villeta'}</h2>
                                        </Link>
                                    </div>
                                    <div className={'col-12'}>
                                        <Link to={'/' + translate_world[this.props.world] + '/galeria/exploradores/villarrica'}>
                                            <h2>{'Villarrica'}</h2>
                                        </Link>
                                    </div>
                                </div>
                            ...
                            <div className={'col-12 col-md-10 row nomargin nopadding'}>
                                <div className={'col-md-7'}>
                                    ...
                                    <div className={'row nomargin nopadding acti-des'}>
                                        <img alt={'muestra'} src={'/static/img/newexploregallery/' +
                                ...
                                <div onClick={() => this.showVideo(config.video)}
                                    ...
                                    <img alt={'video'} src={'/static/img/newexploregallery/' +
                                    this.props.world + '/acti-vid-fg.png'} />
                                </div>
                                <div className={'col-md-5 ssg-se acti-im'}>
                                    <img alt={'des'} src={'/static/img/newexploregallery/' +
